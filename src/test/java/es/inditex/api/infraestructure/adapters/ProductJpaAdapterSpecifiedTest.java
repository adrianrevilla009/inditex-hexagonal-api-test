...
public class ProductJpaAdapterSpecifiedTest {
    ...
    public void testGetProductByBrandProductAndDate1() {
        ...
        when(productRepository.getProductByBrandProductAndDate(productId, brandId, startDate)).thenReturn(Optional.of(dbData.get(0)));
    ...
    public void testGetProductByBrandProductAndDate2() {
        ...
        when(productRepository.getProductByBrandProductAndDate(productId, brandId, startDate)).thenReturn(Optional.of(dbData.get(3)));
    ...
    public void testGetProductByBrandProductAndDate3() {
        ...
        when(productRepository.getProductByBrandProductAndDate(productId, brandId, startDate)).thenReturn(Optional.empty());
